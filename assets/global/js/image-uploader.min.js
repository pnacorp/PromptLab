...
! function (e) {
    e.fn.imageUploader = function (t) {
        ...
        let o = function () {
                ...
                }).appendTo(i), t.on("click", (function (e) {
                    d(e), n.trigger("click")
            ...
            l = function (t, i, o) {
                ...
                return e("<i>", {
                    class: "iui-close"
                }).appendTo(r), o ? (l.attr("data-preloaded", !0), e("<input>", {
                    type: "hidden",
                    name: a.settings.preloadedInputName + "[]",
                    value: i
                }).appendTo(l)) : l.attr("data-index", i), l.on("click", (function (e) {
                    d(e)
            ...
            m = function (e, t) {
                return !(e + s.items.length + a.settings.preloaded.length >= a.settings.maxFiles && ($("#errorModal").modal("show"), 1))
            },
            u = function (t, n) {
