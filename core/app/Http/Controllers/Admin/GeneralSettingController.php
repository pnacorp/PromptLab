...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'base_color_2' => 'nullable|regex:/^[a-f0-9]{6}$/i',
            'secondary_color' => 'nullable|regex:/^[a-f0-9]{6}$/i',
            'timezone' => 'required|integer',
            'currency_format'=>'required|in:1,2,3',
            'paginate_number'=>'required|integer',
            'seller_fixed_charge'=>'required|numeric|gte:0',
            'seller_percent_charge'=>'required|numeric|between:0,100',
        ]);
        ...
        $general->seller_fixed_charge = $request->seller_fixed_charge;
        $general->seller_percent_charge = $request->seller_percent_charge;
        $general->paginate_number = $request->paginate_number;
        $general->base_color = str_replace('#','',$request->base_color);
        $general->base_color_2 = str_replace('#','',$request->base_color_2);
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->prompt_approval = $request->prompt_approval ? Status::ENABLE : Status::DISABLE;
