...
trait UserNotify
{
    public static function notifyToUser()
    {
        return [
            ...
            'hasDepositedUsers'       => 'Users Having Completed Payment',
            'notDepositedUsers'       => 'Users Not Having Completed Payment',
            'pendingDepositedUsers'   => 'Users Having Pending Payment',
            'rejectedDepositedUsers'  => 'Users Having Rejected Payment',
            'topDepositedUsers'     => 'Top Payments Users',
            'hasPromptsUsers'       => 'Users With Prompts',
            'usersWithSales'        => 'Users With Sales',
            'UsersWithPurchase'     => 'Users With Purchase',
    ...
    public function scopeHasPromptsUsers($query)
    {
    ...
    public function scopeUsersWithSales($query)
    {
        return $query->whereHas('sells', function ($q) {
            $q->where('orders.status', Status::ORDER_COMPLETED);
        });
    }

    public function scopeUsersWithPurchase($query)
    {
