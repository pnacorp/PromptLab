        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6 text-center">
                    ...
                    <p class="description">@lang('The page you are looking for doesn\'t exist or an other error ocurred') <br> @lang('or temporarily unavailable.')</p>
                    ...
                    </span><span class="text"> @lang('Go to Home')</span>
                </a>
                </div>
            </div>
        </div>
