...
@section('content')
    ...
    <div class="card custom--card">
        <div class="card-header card-header-bg d-flex flex-wrap gap-2 justify-content-between align-items-center">
            <h5 class="text-white mt-0 mb-0">
        ...
        <div class="card-body">
            <form method="post" class="disableSubmission" action="{{ route('ticket.reply', $myTicket->id) }}" enctype="multipart/form-data">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-9">
                        <button type="button" class="btn btn-outline--base btn--sm addAttachment my-2"> <i class="fas fa-plus"></i> @lang('Add Attachment') </button>
    ...
    <div class="mt-4 d-flex gap-4 flex-column">
        ...
        @forelse($messages as $message)
            @if ($message->admin_id == 0)
                <div class="card custom--card border--base">
                    <div class="card-body">
                        <div class="row">
            ...
            @else
                <div class="card custom--card border border-warning reply-bg">
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-md-3 border-end text-end">
            ...
            <div class="card custom--card">
                <div class="card-body">
                    <div class="empty-message text-center">
                        ...
                        <h5 class="text-muted">@lang('No replies found')</h5>
                    </div>
                </div>
            </div>
        @endforelse
