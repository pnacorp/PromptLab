        ...
        <div class="col-12">
            ...
            <div class="row mt-2 gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    ...
                    <x-widget
                        ...
                        icon="las la-coins"
                        title="Seller Charge"
                        value="{{ showAmount($widget['charge'])}}"
                        bg="primary"
                    />
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="6"
                        link="{{ route('admin.order.approved',$user->id) }}"
                        icon="las la-shopping-cart"
                        title="Purchase"
                        value="{{showAmount($widget['purchase'])}}"
                        bg="info"
                    />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="6"
                        link="{{ route('admin.prompt.approved',$user->id) }}"
                        icon="lar la-check-circle"
                        title="Approve Prompts"
                        value="{{$widget['approved_prompts']}}"
                        bg="success"
                    />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="6"
                        link="{{ route('admin.prompt.rejected',$user->id) }}"
                        icon="las la-times-circle"
                        title="Rejected Prompts"
                        value="{{$widget['rejected_prompts']}}"
                        bg="danger"
                    />
                </div><!-- dashboard-w1 end -->
            </div><!-- row end-->
            ...
            <div class="row gy-4 mt-2">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.prompt.index',$user->id) }}"
                        title="Total prompts"
                        icon="far fa-comment-dots"
                        value="{{ __($promptsCount) }}"
                        bg="info"
                    />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.order.index',$user->id) }}"
                        title="Sale"
