...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-lg-4 col-sm-6">
            <x-widget
                style="5"
                link="{{ route('admin.prompt.approved') }}"
                icon="fas fa-check-circle"
                title="Approve prompt"
                value="{{ $prompt['approved'] }}"
                bg="1"
                border="success"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-lg-4 col-sm-6">
            <x-widget
                style="5"
                link="{{ route('admin.prompt.pending') }}"
        ...
        <div class="col-xxl-3 col-lg-4 col-sm-6">
            <x-widget
                style="5"
                link="{{ route('admin.prompt.featured') }}"
                icon="fas fa-star"
                title="Featured Prompt"
                value="{{ $prompt['featured'] }}"
                bg="4"
            />
        </div><!-- dashboard-w1 end -->
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="7"
                link="{{ route('admin.order.approved') }}"
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="7"
                link="{{ route('admin.order.canceled') }}"
