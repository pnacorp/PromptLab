                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-3 col-sm-6">
                                <label class="required"> @lang('Secondary Base Color')</label>
                                <div class="input-group">
                                    <span class="input-group-text p-0 border-0">
                                        <input type='text' class="form-control colorPicker"
                                            value="{{ gs('base_color_2') }}">
                                    </span>
                                    <input type="text" class="form-control colorCode" name="base_color_2"
                                        value="{{ gs('base_color_2') }}">
                                </div>
                            </div>
                            <div class="form-group col-xl-3 col-sm-6">
                            ...
                            <div class="form-group col-xl-4 col-sm-6 ">
                                <div class="form-group">
                                    <label>@lang('Seller Fixed Charge')</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="seller_fixed_charge"
                                            value="{{ getAmount(gs()->seller_fixed_charge) }}" required />
                            ...
                            <div class="form-group col-xl-4 col-sm-6 ">
                                <div class="form-group">
                                    <label>@lang('Seller Percent Charge')</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="seller_percent_charge"
                                            value="{{ getAmount(gs()->seller_percent_charge) }}" required>
