                ...
                <div class="row notification-alert">
                    <div class="col-lg-12">
                        <div class="card custom--card mb-4">
                            <div class="card-header justify-content-between align-items-center d-flex flex-wrap notice_notify">
                                <h5 class="alert-heading mb-0">@lang('Please Allow / Reset Browser Notification') <i class='las la-bell text--danger'></i></h5>
                            </div>
                            <div class="card-body">
