...
Route::middleware('admin')->group(function () {
    ...
    //AI Tool
    Route::controller('ToolController')->prefix('tool')->name('tool.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');

        Route::get('version/{id}', 'version')->name('version');
        Route::post('version/store/{id?}', 'versionStore')->name('version.store');
        Route::post('version/status/{id}', 'versionStatus')->name('version.status');
    });

    // prompts
    Route::controller('ManagePromptController')->prefix('prompt')->name('prompt.')->group(function () {
        ...
        Route::get('featured/{user_id?}', 'featured')->name('featured');
        Route::get('trending/{user_id?}', 'trending')->name('trending');
    ...
    // Review
    Route::controller('ReviewController')->name('reviews.')->prefix('reviews')->group(function () {
